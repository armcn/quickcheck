...
test_that("posixct_ generates vectors with NA_real_", {
...
test_that("posixct_left_bounded generates left bounded POSIXct", {
  left <- as.POSIXct("2000-01-01 00:00:00")
...
test_that("posixct_right_bounded generates right bounded POSIXct", {
  right <- as.POSIXct("2010-01-01 00:00:00")
