...
test_that(
  "factor_ generates vectors of length 1 by default", {
  for_all(
    a = factor_(),
...
test_that(
  "factor_ generates vectors of specific length", {
  for_all(
...
test_that(
  "factor_ generates vectors within a range of lengths", {
  for_all(
...
test_that("factor_ generates vectors with NAs", {
  for_all(
