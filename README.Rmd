...
[![Codecov test coverage](https://codecov.io/gh/armcn/quickcheck/branch/main/graph/badge.svg)](https://codecov.io/gh/armcn/quickcheck?branch=main)
...
You can install the development version of quickcheck from [GitHub](https://github.com/) with:
...
Here we test the properties of the `distinct` function from 
the `dplyr` package.
